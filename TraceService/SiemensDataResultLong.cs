...
namespace TraceService
{
    ...
    public class SiemensDataResultLong : UDT
    {
        ...
        public Single[] reals = new Single[100];
        public DTL[] dtls = InitializeArray<DTL>(5);
        public SiemensString[] strings = InitializeArray<SiemensString>(5);
